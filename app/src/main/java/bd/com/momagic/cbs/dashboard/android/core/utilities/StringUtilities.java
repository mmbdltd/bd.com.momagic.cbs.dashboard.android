...
public final class StringUtilities {
    ...
    public static String replaceWhiteSpaces(String text, String replacement, boolean replaceSpaces) {
        final String regularExpression = replaceSpaces ? "[ \t\r\n]+" : "[\r\n\t]+";
    ...
    public static String toSeparatedValue(final boolean escape, final String separator, final Object... values) {
        String openingValueWrapper = StringUtilities.getEmptyString();
        String closingValueWrapper = StringUtilities.getEmptyString();
    ...
    public static String toSeparatedValue(
        ...
        final StringBuilder separatedValueBuilder = new StringBuilder(STRING_BUILDER_INITIAL_CAPACITY);
        // we shall create a new date format...
        // NOTE: NEED TO CREATE NEW DATE FORMAT BECAUSE IT IS GENERALLY NOT THREAD-SAFE...
        final DateFormat dateTimeFormat = DateTimeFormatter.createDateFormat();
        ...
        for (int i = 0; i < values.length; ++i) {
            ...
            String valueAsString = getEmptyString();
            ...
            if (value != null) {
                ...
                if (value instanceof Date) {
                    ...
                    valueAsString = dateTimeFormat.format(valueAsDate);          // <-- we shall format the date value...
                } else {
                    valueAsString = value.toString();                            // <-- otherwise, we shall convert the value to string...
                }
        ...
        final String separatedValue = separatedValueBuilder
