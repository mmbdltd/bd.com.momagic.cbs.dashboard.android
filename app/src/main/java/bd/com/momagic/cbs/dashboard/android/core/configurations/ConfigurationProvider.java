...
public final class ConfigurationProvider {
    ...
    public static Configuration loadConfiguration(final Context context) throws Exception {
        ...
        // setting cache directory from context to configuration...
        configuration.setCacheDirectory(context.getCacheDir().getAbsolutePath());
        // setting files directory from context to configuration...
        configuration.setFilesDirectory(context.getFilesDir().getAbsolutePath());
