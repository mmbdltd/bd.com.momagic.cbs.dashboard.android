...
public class SingletonServiceProvider implements ServiceProvider {
    ...
    private final Logger logger = LoggerFactory.getLogger(SingletonServiceProvider.class);
    ...
    private <Type> boolean isInstanceAvailable(Object instance, Class<Type> serviceClass) {
    ...
    private Object getInstance(String key) {
        ...
        final Object instance = instanceMap.get(key);
    ...
    private <Type> Object createInstance(
        ...
        try {
            ...
            if (instantiator == null) {
                ...
                final Constructor<Type> constructor = serviceClass.getDeclaredConstructor();
                ...
                if (instance == null) {
                    ...
                    logger.warn("Instantiator returned 'null' for \"" + key + "\".");
                }
            }

            // logger.log(Level.DEBUG, "Service instantiation succeeded for \"" + key + "\".");
        } catch (Exception exception) {
            logger.error("An exception occurred while instantiating service of \"" + key + "\".", exception);
    ...
    public <Type> Type get(
        ...
        final String typeName = serviceClass == null        // <-- if service class is null...
                ? StringUtilities.getEmptyString()          // <-- we shall assign an empty string...
                : serviceClass.getName();                   // <-- otherwise, we shall retrieve the type name...
    ...
    public <Type> Type get(
        ...
        // sanitizing the key...
        final String sanitizedKey = StringUtilities.getDefaultIfNullOrWhiteSpace(
        ...
        Object instance = getInstance(sanitizedKey);

        readLock.unlock();          // <-- read synchronization ends here...

        // checks if the instance retrieved from the map is available...
        boolean instanceAvailable = isInstanceAvailable(instance, serviceClass);
